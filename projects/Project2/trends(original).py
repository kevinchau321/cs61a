...
def tweet_location(tweet): #makes position
	...
	return make_position(tweet['latitude'],tweet['longitude']) #makes position tuple
...
def extract_words(text):
	...
	"""
	"*** YOUR CODE HERE ***"
	words_only = "" #create new blank string
	for character in text:
		if character in ascii_letters:
			words_only = words_only + character
		else:
			words_only = words_only + " " #replaces spaces and punctuation with blank spaces
...
def group_tweets_by_state(tweets):
	...
	"""
	def nearest_state(tweet_location(tweet)):
