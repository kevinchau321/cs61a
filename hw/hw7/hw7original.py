...
def union_set2(set1, set2):
	...
	if empty(set1) and empty(set2):
		...
		if set1.first < set2.first:
			return Rlist(set1.first, union_set2(set1.rest, set2.first))
		if set2.first < set1.first:
			return Rlist(set2.first, union_set2(set1.first, set2.rest))
