...
def partial_tree(s, n):
    ...
    entry = partial_tree(s, left_size)[1].first
    s_right = partial_tree(s, left_size)[1].rest
    right_branch = partial_tree(s_right, right_size)[0]
    left_over = partial_tree(s_right, right_size)[1]
    return Tree(entry, left_branch, right_branch), left_over
