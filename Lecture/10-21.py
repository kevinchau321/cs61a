...
oski = Bear()
Bear.__repr__ = lambda self: 'I am a Bear'
oski.__repr__ = lambda: 'I am Oski'
...
class Rational:
	...
	@property###call when method is looked up, without having to explicitly call with zero () arguments
